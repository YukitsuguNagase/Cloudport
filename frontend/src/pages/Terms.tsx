      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="space-y-6 text-gray-700">
            ...
            <section>
              <h2 className="text-xl font-bold mb-3">第4条（料金および支払い）</h2>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3">第5条（契約成立の報告義務）</h2>
              <div className="space-y-2">
                <p>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3">第6条（禁止事項）</h2>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3">第7条（当サービスの提供の停止等）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3">第8条（利用制限および登録抹消）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3">第10条（サービス内容の変更等）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3">第11条（利用規約の変更）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3">第12条（準拠法・裁判管轄）</h2>
              <p>
